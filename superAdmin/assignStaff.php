...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $queryi=mysqli_query($conn,"select * from tblassignedstaff where staffId = '$staffId'");
        ...
        $statusMsg="This Staff has been Assigned to a Department!";
            ...
            $query=mysqli_query($conn,"insert into tblassignedstaff(staffId,departmentId,facultyId,dateAssigned) value('$staffId','$departmentId','$facultyId','$dateAssigned')");
            if($query){

                $querys=mysqli_query($conn,"update tblstaff set isAssigned='1' where staffId='$staffId'");
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php
        $ret=mysqli_query($conn,"SELECT tblassignedstaff.dateAssigned,tblassignedstaff.staffId, tblstaff.staffId,tblstaff.firstName, tblstaff.lastName, tblstaff.otherName,
