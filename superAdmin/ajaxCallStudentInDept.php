<?php
        ...
        $queryss=mysqli_query($conn,"select * from tblstudent where departmentId=".$deptId." ORDER BY firstName ASC");                        
        $countt = mysqli_num_rows($queryss);

        $crsquery=mysqli_query($conn,"select * from tblcourse where departmentId=".$deptId." ORDER BY courseTitle ASC");                        
