...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $queryi=mysqli_query($conn,"select * from tblassignedadmin where facultyId = '$facultyId' and departmentId = '$departmentId'");
        ...
        $statusMsg="An Administrator has been Assigned to this Department!";
            ...
            $query=mysqli_query($conn,"insert into tblassignedadmin(staffId,departmentId,facultyId,dateAssigned) value('$staffId','$departmentId','$facultyId','$dateAssigned')");
            if($query){

                $querys=mysqli_query($conn,"update tbladmin set isAssigned='1' where staffId='$staffId'");
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <label for="select" class=" form-control-label">Select Administrator</label>
                                             <?php 
                                                $que=mysqli_query($conn,"select * from tbladmin where adminTypeId != 1 and isAssigned = 0"); //selects unassigned staffs                        
                                         ...
                                         <div class="row">
                                               <div class="col-6">
                                                ...
                                                <?php 
                                                $query=mysqli_query($conn,"select * from tblfaculty ORDER BY facultyName ASC");                        
