...
<main>
	<!-- ------------------ HEADER -------------------- -->
	 <header id="header" class="fixed-top">
		<div class="container d-flex align-items-center">
			<a class="navbar-brand" href="index.php"><img src="assets/img/student-grade.png" alt="logo" style="width:30p;height:30px;"></a>
			<h1 class="logo mr-auto"><a href="index.php">GITB | GRADING </a></h1>
	...
	<!-- ------------------ MAIN CONTENT / HERO SECTION ENDS -------------------- -->
	...
	<section id="about" class="about">
		<div class="container" data-aos="fade-up">
			...
			<div class="section-title">
				<h2>Our Mission</h2>
				<p> To empower students to excel academically and socially, by providing them with the tools and resources they need to succeed. </p>
			</div>

			<div class="row">
				<div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
					<img src="assets/img/ronk1.jpg" class="img-fluid" alt="">
				</div>

				<div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam nobis exercitationem eaque eveniet dolor dolores porro, dolorem repellat, beatae veritatis asperiores illum laborum laboriosam iste cupiditate sint temporibus officia praesentium.</p>
	...
	<footer id="footer">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 footer-contact">
						<h3>GENIUS IT BRAINERY</h3>
						<p>
							P.O. BOX 1413, <br>
							Rams Horn Building, Opposite Winners Chapel, Barracks Road<br><br>
							<strong>Phone:</strong> 0536331169 | 0204295241<br>
							<strong>E-mail:</strong> info@geniusitbrainery.com<br>
						</p>
					</div>
		...
		<div class="container d-md-flex py-4">
			...
			<div class="mr-md-auto text-center text-md-left">
				<div class="copyright">
					&copy; <strong><span>GITB</span></strong> - <strong> <?php echo date('Y');?> - Developed By Ghost </strong>
				</div>
				<div class="credits">
	...
	<a href="#" class="back-to-top"><i class="bx bx-up-arrow-alt"></a>
