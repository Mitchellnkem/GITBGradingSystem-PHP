<?php
    ...
    $sid = intval($_GET['sid']);//gradeId
       ...
       $queryss=mysqli_query($conn,"select * from tblstaff where Id=".$sid."");                        
       $countt = mysqli_num_rows($queryss);
       $row = mysqli_fetch_array($queryss);

       $staffId = $row['staffId'];

       $ret=mysqli_query($conn,"SELECT tblassignedstaff.staffId, tblroles.roleName, tbldepartment.departmentName, tblfaculty.facultyName
